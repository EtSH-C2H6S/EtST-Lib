...
public interface CustomEnergyBarModifierHook {
    ...
    record AllMerger(Collection<CustomEnergyBarModifierHook> modules) implements CustomEnergyBarModifierHook {
        @Override
        public boolean showEnergyBar(IToolStackView tool, ModifierEntry entry){
            boolean show =false;
            for (CustomEnergyBarModifierHook module:this.modules){
